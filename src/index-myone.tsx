...
const authConfig: TAuthConfig = {
    clientId: 'public-client-myid-sso',
    authorizationEndpoint: 'https://sso.digital-id.my/realms/didtest/protocol/openid-connect/auth',
    tokenEndpoint: 'https://sso.digital-id.my/realms/didtest/protocol/openid-connect/token',
    logoutEndpoint: 'https://sso.digital-id.my/realms/didtest/protocol/openid-connect/logout',
